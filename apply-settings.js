...
(async function() {
    ...
    const initLogosAndTheme = () => {
        const logoSrc = savedTheme === 'light' ? '/uploads/media/white%20logo.png' : '/uploads/media/black%20logo.png';
        ...
        toggleInput.addEventListener('change', (e) => {
            ...
            // Update Logos
            const newLogoSrc = newTheme === 'light' ? '/uploads/media/white%20logo.png' : '/uploads/media/black%20logo.png';
            document.querySelectorAll('img[alt="Neobium Logo"]').forEach(img => {
